...
def create():
    try:
        ...
        if data['dbms_type'] == "mysql":
            ...
            response = requests.get('http://10.0.4.87:40800/mysql/create', params=param)
        else:
            param = {"dbname":data['instance_name']}
            response = requests.get('http://10.0.4.87:40800/opencsd/create', params=param)              
...
if __name__ == '__main__':
    app.run(host="0.0.0.0", port=40802, debug=True)
